...
const Category = () => {
    ...
    const list = productList.filter((each) => Number(id) === each.category_id )
    const categoryName = categoris.filter((each) => Number(id) === each.id )
    

    return (
        <div className="category-main-content">
            <div className="layout">
                <h1 className="category-title">{categoryName[0].name}</h1>
